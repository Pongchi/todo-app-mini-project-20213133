function Sidebar({ filter, setFilter, activeCount, completedCount, totalCount }) {
  const navItems = [
    { id: 'active', label: 'Today', count: activeCount, icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
      </svg>
    )},
    { id: 'all', label: 'Upcoming', count: totalCount, icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
  ...
  return (
    <div className="w-60 flex flex-col p-5 bg-white flex-shrink-0">
      {/* Header */}
          ...
          {navItems.map(item => (
            ...
            >
              <div className="flex items-center gap-2">
                <span className={filter === item.id ? 'text-gray-700' : 'text-gray-400'}>
                  {item.icon}
                </span>
